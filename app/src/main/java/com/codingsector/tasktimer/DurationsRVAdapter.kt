...
import kotlinx.android.synthetic.main.task_durations_items.view.*
import java.util.*
...
class DurationsRVAdapter(context: Context, private var cursor: Cursor?) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (cursor != null && cursor.count != 0) {
            ...
            holder.containerView.td_description?.text =
                description     // Description is not present in portrait
    ...
    private fun formatDuration(duration: Long): String {
        // duration is in seconds, convert into hours:minutes:seconds

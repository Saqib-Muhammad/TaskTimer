...
//        fun onDialogCancelled(dialogId: Int) {}
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        // fix, "smart cast the Bundle is impossible, because argument is immutable property that could have been changed by this time"
    ...
    override fun onDetach() {
        ...
        // Reset the activity call back interface, because we're no longer attached.
        dialogEvents = null
    }
